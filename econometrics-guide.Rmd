...
optim(c(1,1,-1,-1,-1), method="L-BFGS-B", fn=ols.lf1, lower=c(1e-6,-Inf,-Inf,-Inf,-Inf), upper=rep(Inf,5), y=y, X=as.matrix(X))
...
![Effects of truncation and censoring from Davidson and MacKinnon](davidson.jpg)
...
![Various hazard functions from Davidson and MacKinnon](davidson2.jpg)
