...
\begin{figure}[htbp] \footnotesize \caption{\small Effects of truncation and censoring from Davidson and MacKinnon}
\centerline{\includegraphics[width=4in,height=3in]{davidson.jpg}}
\label{fig:censor}
\end{figure}
...
\begin{figure}[htbp] \footnotesize \caption{\small Various hazard functions from Davidson and MacKinnon}
\centerline{\includegraphics[width=4in,height=3in]{davidson2.jpg}}
\label{fig:harzard}
\end{figure}
